 ...
 export async function convertNumberIntoNpNumWord(data){
  ...
  function thousands(num) {
    const front =
      parseInt(num.slice(0, -3)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-3)) !== 0 ? hundreds(num.slice(-3)) : "";
  ...
  function lakhs(num) {
    const front =
      parseInt(num.slice(0, -5)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-5)) !== 0 ? thousands(num.slice(-5)) : "";
  ...
  function neel(num) {
    const front =
      parseInt(num.slice(0, -13)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-13)) !== 0 ? kharab(num.slice(-13)) : "";
  ...
  function shankh(num) {
    const front =
      parseInt(num.slice(0, -17)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-17)) !== 0 ? padam(num.slice(-17)) : "";
  ...
  function upadh(num) {
    const front =
      parseInt(num.slice(0, -19)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-19)) !== 0 ? shankh(num.slice(-19)) : "";
  ...
  function ank(num) {
    const front =
      parseInt(num.slice(0, -21)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-21)) !== 0 ? upadh(num.slice(-21)) : "";
  ...
  function ant(num) {
    const front =
      parseInt(num.slice(0, -29)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-29)) !== 0 ? parardh(num.slice(-29)) : "";
  ...
  function shishant(num) {
    const front =
      parseInt(num.slice(0, -33)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-33)) !== 0 ? mahaant(num.slice(-33)) : "";
  ...
  function shinghr(num) {
    const front =
      parseInt(num.slice(0, -35)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-35)) !== 0 ? shishant(num.slice(-35)) : "";
  ...
  function mahaSighr(num) {
    const front =
      parseInt(num.slice(0, -37)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-37)) !== 0 ? shinghr(num.slice(-37)) : "";
  ...
  function adantSighr(num) {
    const front =
      parseInt(num.slice(0, -39)) !== 0
        ...
        : false;
    const rest =
      parseInt(num.slice(-39)) !== 0 ? mahaSighr(num.slice(-39)) : "";
  ...
  function formatNepaliNumber(number) {
    ...
    while (otherDigits.length > 0) {
      ...
      nepaliFormatted =
        pair + (nepaliFormatted ? "," + nepaliFormatted : "");
